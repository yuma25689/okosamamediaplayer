 ...
 * 現在再生中のアルバムアートとplay/pauseトグルボタン、nextトラックボタンのある単純なWidget
 * おそらく、ホーム画面用 
 */
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        // Mediaplaybackserviceにbroadcastインテントを送信
        // 即時更新をラップできる？
    ...
    private void defaultAppWidget(Context context, int[] appWidgetIds) {
        ...
        // タイトルを消し、テキストビューのテキストを初期値に設定
        views.setViewVisibility(R.id.title, View.GONE);
        views.setTextViewText(R.id.artist, res.getText(R.string.widget_initial_text));

        // そんなにちゃんと読んでいない。ボタン押下時の処理の紐付けか？
     ...
     * MediaPlaybackServiceからの通知をハンドルする
     */
    ...
    void performUpdate(MediaPlaybackService service, int[] appWidgetIds) {
        ...
        // トラック番号に基づいてタイトルをフォーマットするか、SDカードのメッセージを表示
