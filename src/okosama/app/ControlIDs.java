...
public interface ControlIDs {
	...
	public static final int EXTERNAL_TAB_BUTTON = 103;
	public static final int STOP_BUTTON = 105;
	public static final int TWEET_BUTTON = 104;
	public static final int SHUFFLE_BUTTON = 106;
	public static final int REPEAT_BUTTON = 107;
